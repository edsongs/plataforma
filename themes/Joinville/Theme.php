...
class Theme extends BaseV1\Theme{
    ...
    protected static function _getTexts(){
        return array(
            'site: in the region' => 'na Cidade de Joinville',
            'site: of the region' => 'da Cidade de Joinville',
            'site: owner' => 'Secretaria de Cultura e Turismo de Joinville',
            'site: by the site owner' => 'pela Secretaria de Cultura e Turismo de Joinville',

            'home: title' => "Bem-vind@ plataXforma " . App::i()->siteName,
            'home: abbreviation' => "SECULT",
//            'home: colabore' => "Colabore com o Mapas Culturais",
            'home: welcome' => "
                <p>Esta plataforma é o elo entre os agentes culturais, espaços, projetos, eventos e as pessoas interessadas em Cultura. A cidade de Joinville, em consonância com as diretrizes do Ministério da Cultura (MinC), disponibiliza a partir de agora, informações sobre a Cultura da cidade a toda a comunidade.</p>
                <p>O Mapa Cultural de Joinville é uma plataforma livre, gratuita e colaborativa de mapeamento do cenário cultural Joinvilleense. Com ela a comunidade pode inteirar-se dos acontecimentos culturais sejam eles oficiais desenvolvidos pelo poder público ou desenvolvidos pela iniciativa privada. Para que toda a agenda cultural encontre-se no O Mapa Cultural de Joinville é necessário que os agentes culturais se cadastrem e mantenham atualizadas suas ações culturais.</p>
                <p>Por fim, o O Mapa Cultural de Joinville torna-se um repositório de informações culturais da cidade, ou seja, ele permite que sejam contabilizadas as ações culturais realizadas na cidade servindo para monitoramento da evolução da Cultura no município.</p>
            ",
    ...
    public function addDocumentMetas() {
        ...
        foreach ($this->documentMeta as $key => $meta){
            if(isset($meta['property']) && ($meta['property'] === 'og:image' || $meta['property'] === 'og:image:url')){
                $this->documentMeta[$key] = array('property' => $meta['property'] , 'content' => $app->view->asset('img/share-JVE.png', false));
            }
        }
    }
}
